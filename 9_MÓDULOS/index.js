...
//importando variavel
const variable_js_1 = require("./variable.js"); // por ser uma desestruturação x deve ser importado entre chaves
...
console.log(multiple_js_1.c);
console.log(multiple_js_1.d);
